...
import com.example.jangdocdaefilm.common.MemberFileUtils;
...
public class MemberServiceImpl implements MemberService {
    ...
    @Override
    public List<MemberDto> setMemberImg(MemberDto member, MultipartHttpServletRequest uploadFiles) throws Exception {
        List<MemberDto> fileList = memberFileUtils.parseMemberFileInfo(member.getId(), uploadFiles);
        if (!CollectionUtils.isEmpty(fileList)) {
            memberMapper.setMemberImg(fileList);
        }
        return fileList;
    }
